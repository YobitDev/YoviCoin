...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "YoviCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"37.1.193.77", "37.1.193.77"},
    {"62.162.181.2", "62.162.181.2"},
    {"192.52.166.80", "192.52.166.80"},    
    {"70.92.184.203", "70.92.184.203"},        
    {"109.87.255.75", "109.87.255.75"},                
    {"155.99.160.206", "155.99.160.206"},   
    {"2.179.149.174", "2.179.149.174"},                            
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("YoviCoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. YoviCoin is probably already running."), addrBind.ToString().c_str());
        else
